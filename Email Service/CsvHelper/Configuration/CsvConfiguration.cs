...
namespace CsvHelper.Configuration
{
    ...
    public class CsvConfiguration
    {
        ...
        ///     The <see cref="P:CsvHelper.Configuration.CsvConfiguration.Encoding" /> needs to be set correctly for this to be
        ///     accurate.
        /// </summary>
        ...
        /// </summary>
        public virtual BindingFlags PropertyBindingFlags { get; set; } = BindingFlags.Instance | BindingFlags.Public;
        ...
        ///     <see cref="P:CsvHelper.Configuration.CsvConfiguration.QuoteNoFields" /> cannot be true at the same time. Turning
        ///     one
        ...
        ///     <see cref="P:CsvHelper.Configuration.CsvConfiguration.QuoteAllFields" /> and
        ///     <see cref="P:CsvHelper.Configuration.CsvConfiguration.QuoteNoFields" /> cannot be true
        ...
        {
            var csvClassMap =
                (CsvClassMap) ReflectionHelper.CreateInstance(typeof(DefaultCsvClassMap<>).MakeGenericType(type));
            csvClassMap.AutoMap(IgnoreReferences, PrefixReferenceHeaders);
            return csvClassMap;
        }
        ...
        {
            quoteRequiredChars = delimiter.Length > 1 ? new[] {'\r', '\n'} : new[] {'\r', '\n', delimiter[0]};
        }
        ...
        public virtual TMap RegisterClassMap<TMap>()
            where TMap : CsvClassMap
        {
            var tMap = ReflectionHelper.CreateInstance<TMap>();
        ...
        public virtual CsvClassMap RegisterClassMap(Type classMapType)
        {
            ...
            var csvClassMap = (CsvClassMap) ReflectionHelper.CreateInstance(classMapType);
            RegisterClassMap(csvClassMap);
            return csvClassMap;
        }
