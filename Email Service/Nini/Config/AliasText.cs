...
namespace AnEmailService.Nini.Config
{
    ...
    public class AliasText
    {
        ...
        {
            if (!booleanAlias.Contains(key)) throw new ArgumentException("Alias does not exist for text");
        ...
        {
            if (!intAlias.Contains(key)) throw new ArgumentException("Alias does not exist for key");
