...
namespace AnEmailService.Nini.Config
{
    ...
    public class ConfigCollection : ICollection, IEnumerable, IList
    {
        ...
        {
            if (configList.Contains(config)) throw new ArgumentException("IConfig already exists");
